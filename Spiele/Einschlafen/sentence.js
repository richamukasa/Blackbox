var FallAsleep;
(function (FallAsleep) {
    class Sentence extends FallAsleep.Form {
        checkDiv;
        dragWrap;
        dropWrap;
        sentence;
        ...
        word;
        wordCount;
        constructor(_position, _sentence, _mixup) {
            super(_position);
            ...
            while (this.mixup.length > 1) {
                console.log(this.sentence);
                let x = Math.floor(Math.random() * this.mixup.length);
            ...
            for (let i = 0; i < this.mix.length; i++) {
                console.log(_sentence);
                let wordDrag = document.createElement("div");
                let wordDrop = document.createElement("div");
        ...
        dropWord(_target) {
            if (FallAsleep.globalGame) {
                console.log(this.sentence);
                FallAsleep.dropWord(_target);
                let sentenceWrap = this.dropWrap.getElementsByClassName("sentenceWrap");
                console.log(sentenceWrap);
                for (let i = 0; i < sentenceWrap.length; i++) {
                    console.log("oida");
        ...
        checkSentence() {
            ...
            let sentenceWrap = this.dropWrap.getElementsByClassName("sentenceWrap");
            let correct = this.dropWrap.getElementsByClassName("correct");
        ...
        confirm() {
            ...
            let incorrect = this.dropWrap.getElementsByClassName("incorrect");
            console.log(incorrect);
