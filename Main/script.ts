...
function handleLoad(): void {
    let enterButton: HTMLDivElement = document.querySelector("#mynd");
...
function loadLevelSelection(): void {
    if (boxId == null) {
        ...
        let levelBoxes: HTMLCollection | null = document.getElementsByClassName("container");
        for (let i: number = 0; i < levelBoxes.length; i++) {
...
function loadPersonas(): void {
    ...
    let settings: HTMLDivElement = document.createElement("div");
    let sidebar: HTMLDivElement = document.createElement("div");
    let setLink: HTMLDivElement = document.createElement("div");
...
function setId(): void {
    ...
    if (boxId == "Howto: Relax") {
        let playButton: HTMLDivElement = document.querySelector(`#confirm`);
        let link: HTMLAnchorElement = document.createElement("a");
        link.href = "https://richamukasa.github.io/Blackbox/Spiele/Einschlafen/einschlafen.html";
        link.target = "_blank";
        link.innerText = "SPIELEN"
