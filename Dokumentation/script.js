...
(function (Documentation) {
    ...
    function handleLoad() {
        ...
        let rootWrap = document.createElement("div");
    ...
    function showChapter(_chapter, _div) {
        console.log("tmm");
        _div.innerText = "";
    ...
    function showLetter(_div) {
        _div.innerHTML = _div.id;
        console.log("wah");
    }
    function showHeadline(_chapter, _id) {
        console.log("ham");
        let headline = document.querySelector(`#headline${_chapter}`);
        if (_chapter == 1) {
            if (_id == 0)
    ...
    function showText(_chapter, _id) {
        let detail = document.querySelector(`#detail${_chapter}`);
        if (_chapter == 1) {
            if (_id == 0)
